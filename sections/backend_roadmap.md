# Моя индивидуальная карта развития бэкэнд - разработчика, вдохновлена [репозиторием](https://github.com/zualex/devmap)
...
Рекомендуется ознакомиться с [алгоритмами](#Алгоритмы-) хотя бы на базовом уровне. Так как структуры данных реализованы с помощью алгоритмов, алгоритмы - с помощью структур данных.
